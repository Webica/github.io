...
/* harmony import */ var _hamburger_hamburger__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_hamburger_hamburger__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _officeCard_officeCard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./officeCard/officeCard */ "./src/components/officeCard/officeCard.js");
/* harmony import */ var _officeCard_officeCard__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_officeCard_officeCard__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _invest_invest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./invest/invest */ "./src/components/invest/invest.js");
/* harmony import */ var _grid_grid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./grid/grid */ "./src/components/grid/grid.js");
/* harmony import */ var _input_input__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./input/input */ "./src/components/input/input.js");
/* harmony import */ var _mainmenu_mainmenu__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mainmenu/mainmenu */ "./src/components/mainmenu/mainmenu.js");
/* harmony import */ var _service_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./service/service */ "./src/components/service/service.js");
/* harmony import */ var _recall_recall__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./recall/recall */ "./src/components/recall/recall.js");
/* harmony import */ var _modal_modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal/modal */ "./src/components/modal/modal.js");
/* harmony import */ var _top_slider_top_slider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./top-slider/top-slider */ "./src/components/top-slider/top-slider.js");
...
var enquire = __webpack_require__(/*! enquire.js */ "./node_modules/enquire.js/src/index.js");

var _require = __webpack_require__(/*! ../overlay/overlay */ "./src/components/overlay/overlay.js"),
    overlayAdd = _require.overlayAdd,
    overlayRemove = _require.overlayRemove;

var hamburger = document.querySelector('.hamburger--js');
var mainmenu = document.querySelector('.header .mainmenu');
...
var headerFixed = function headerFixed() {
  if (self.scrollY > 0 && !header.classList.contains('fixed')) {
    header.classList.add('fixed');
  } else if (self.scrollY === 0) {
...
var inputList = document.querySelectorAll('.input__input');
...
phones.forEach(function (item) {
  var phoneMask = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(item, {
...
/***/ "./src/components/invest/invest.js":
/*!*****************************************!*\
  !*** ./src/components/invest/invest.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use(swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Lazy);
var investSlider = document.querySelector('.invest__slider');
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](investSlider, {
  loop: true,
  lazy: true,
  pagination: {
    el: '.invest__pagination-years',
    clickable: true,
    renderBullet: function renderBullet(index, className) {
      return "<div class=\"invest__pagination-year ".concat(className, "\"><span>").concat(2018 + index, "</span></div>");
    }
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _overlay_overlay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../overlay/overlay */ "./src/components/overlay/overlay.js");

var links = document.querySelectorAll('.mainmenu__link');
...
function clickHandler(e) {
  ...
  (0,_overlay_overlay__WEBPACK_IMPORTED_MODULE_0__.overlayRemove)();
}
...
var openModal = function openModal() {
  ...
  (0,_overlay_overlay__WEBPACK_IMPORTED_MODULE_0__.overlayAdd)();
};
document.addEventListener('click', function (e) {
  var target = e.target;

  if (!target.closest('.modal') && !target.closest('.recall') || target.closest('.modal__close')) {
...
/***/ "./src/components/officeCard/officeCard.js":
/*!*************************************************!*\
  !*** ./src/components/officeCard/officeCard.js ***!
  \*************************************************/
/***/ (() => {

var openOfficeInfo = function openOfficeInfo(target) {
  if (target.closest('.officeCard__more')) {
    target.closest('.officeCard').classList.add('active');
  }
};

var closeOfficeInfo = function closeOfficeInfo(target) {
  if (!target.closest('.officeCard__modal') && !target.closest('.officeCard__more')) {
    var officeCardList = document.querySelectorAll('.officeCard');
    officeCardList.forEach(function (item) {
...
document.addEventListener('click', function (e) {
  var target = e.target;
  openOfficeInfo(target);
  closeOfficeInfo(target);
});
...
function overlayAdd() {
  ...
  body.querySelector('.header').appendChild(overlay);
}
...
/***/ "./src/components/recall/recall.js":
/*!*****************************************!*\
  !*** ./src/components/recall/recall.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var recall = document.querySelector('.recall a');
recall.addEventListener('click', function (e) {
  e.preventDefault();
  (0,_modal_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)();
});
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use(swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination); // autoplay timer

var timer = 5000;
var swiper1 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.service__container', {
  autoplay: {
    delay: timer,
...
var swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.service__slider', {
  autoplay: {
    delay: timer,
    disableOnInteraction: false
  },
...
/***/ "./src/components/top-slider/top-slider.js":
/*!*************************************************!*\
  !*** ./src/components/top-slider/top-slider.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.top-slider', {
  loop: true,
  navigation: {
